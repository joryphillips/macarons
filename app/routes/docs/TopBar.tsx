...
import { Box, HStack, IconButton } from "~/components/ui";
import {
  ghostPrimaryStyles,
  iconSizeVariants,
...
const GitHubLink = () => (
  <Link
    to="https://github.com/joryphillips/macarons"
    className={clsx(
      baseReset,
      buttonReset,
      ghostPrimaryStyles,
  ...
  >
    <svg
      ...
      height="24"
      width="24"
      fill={vars.colors.primary.lowContrastText}
    >
      <title>GitHub</title>
